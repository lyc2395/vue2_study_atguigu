<template>
  <el-container class="layout-container-demo" style="height: 500px">
    <el-container>
      <el-header style="text-align: right; font-size: 12px; background-color: #424243">
        <div class="toolbar">
          <el-dropdown>
            <el-icon style="margin-right: 8px; margin-top: 1px ;background-color: #E5EAF3;">
              <setting />
            </el-icon>
            <template #dropdown>
              <el-dropdown-menu>
          ...
          <span style="color: #E5EAF3;">Tom</span>
        </div>
      </el-header>
      <el-container>
